...
namespace scripting {
  ...
  struct PluginLintFinding {
    enum class Kind {
      ...
      ObsoleteConfigAccessor, // entry-specific getConfig alias removed in favor of motion.getConfig
...
namespace motion::plugins {
  ...
  // Entry point for `motion plugins <command> [paths]`. Returns a process exit
