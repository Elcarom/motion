...
bool PipeWireSpectrum::Stream::start() {
  ...
  auto* props = pw_properties_new(
      PW_KEY_MEDIA_TYPE, "Audio", PW_KEY_MEDIA_CATEGORY, "Monitor", PW_KEY_MEDIA_NAME, "Motion Spectrum",
      PW_KEY_APP_NAME, "Motion Spectrum", PW_KEY_STREAM_MONITOR, "true", PW_KEY_STREAM_CAPTURE_SINK, "true",
  ...
  m_stream = pw_stream_new(core, "motion-spectrum", props);
  if (m_stream == nullptr) {
