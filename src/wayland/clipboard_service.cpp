...
namespace {
  ...
  constexpr std::size_t kMinHistoryMaxEntries = static_cast<std::size_t>(motion::config::kClipboardHistoryMinEntries);
  constexpr std::size_t kMaxHistoryMaxEntries = static_cast<std::size_t>(motion::config::kClipboardHistoryMaxEntries);
...
std::string ClipboardService::stateDirectory() {
  ...
  return FileUtils::cacheDir() + "/clipboard";
}
