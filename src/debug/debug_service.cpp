...
namespace {
  ...
  const sdbus::ServiceName kDebugBusName{"dev.motion.Debug"};
  const sdbus::ObjectPath kDebugObjectPath{"/dev/motion/Debug"};
  constexpr auto kDebugInterface = "dev.motion.Debug";
