...
namespace settings {
  ...
  namespace {
    ...
    const std::vector<WidgetTypeSpec> kWidgetTypeSpecs = {
        ...
        {.type = "control-center", .labelKey = "settings.widgets.types.control-center", .glyph = "motion"},
    ...
    std::string widgetGlyph(std::string_view type, const WidgetConfig* config = nullptr) {
      ...
      if (type == "control-center") {
        return nonEmptyGlyph(config->getString("glyph", "motion"), "search");
      }
  ...
  motion::config::schema::WidgetSettingSchema widgetSettingSchema(std::string_view type) {
    motion::config::schema::WidgetSettingSchema out;
  ...
  motion::config::schema::WidgetSettingSchema
  ...
  std::optional<motion::config::schema::WidgetSettingField>
