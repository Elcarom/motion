...
namespace settings {
  ...
  struct WidgetSettingSpec {
    motion::config::schema::WidgetSettingField schema; // validity: key/type/default/range/enumValues
  ...
  [[nodiscard]] motion::config::schema::WidgetSettingType schemaTypeForControl(WidgetControlKind control);
  ...
  [[nodiscard]] motion::config::schema::WidgetSettingSchema widgetSettingSchema(std::string_view type);
  [[nodiscard]] motion::config::schema::WidgetSettingSchema widgetSettingSchema(
      std::string_view type, const WidgetConfig* config, scripting::PluginRegistry* pluginRegistry = nullptr
  );
  [[nodiscard]] std::optional<motion::config::schema::WidgetSettingField>
