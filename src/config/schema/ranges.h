...
namespace motion::config::schema {
  ...
  inline constexpr Range<std::int64_t> kClipboardHistoryMaxEntriesRange{
      motion::config::kClipboardHistoryMinEntries,
      motion::config::kClipboardHistoryMaxEntries,
      motion::config::kClipboardHistoryStepEntries,
  };
