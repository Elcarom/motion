...
void Application::initUiRenderSurfacesAndSettings() {
  ...
  m_settingsWindow.setOpenDesktopWidgetEditor([this]() {
    ...
    if (!wasEditing && m_desktopWidgetsController.isEditing()) {
      notify::info(
          "Motion", i18n::tr("notifications.internal.desktop-widgets-editor"),
  ...
  m_settingsWindow.setOpenLockscreenWidgetEditor([this]() {
    ...
    if (m_lockScreen.isActive()) {
      notify::info(
          "Motion", i18n::tr("notifications.internal.lockscreen-widgets-editor"),
...
void Application::performGreeterSync(bool quiet) {
  ...
  const auto complete = [this, generation, quiet](bool success) {
    ...
    if (success) {
      if (!quiet) {
        DeferredCall::callLater([this]() {
          notify::info(
              "Motion", i18n::tr("notifications.internal.greeter-sync"),
    ...
    DeferredCall::callLater([this, quiet]() {
      if (quiet) {
        notify::error(
            "Motion", i18n::tr("notifications.internal.greeter-sync"), i18n::tr("settings.errors.sync-greeter")
        );
      } else {
  ...
  if (!quiet) {
    ...
    notify::info("Motion", i18n::tr("notifications.internal.greeter-sync"), i18n::tr(pendingBodyKey));
  }
...
void Application::initPanelManagerAndPanels() {
  ...
  m_settingsWindow.setResetLauncherUsage([this]() {
    ...
    notify::info(
        "Motion", i18n::tr("notifications.internal.launcher-usage-reset"),
  ...
  m_settingsWindow.setResetScreenTime([this]() {
    ...
    notify::info(
        "Motion", i18n::tr("notifications.internal.screen-time-reset"),
