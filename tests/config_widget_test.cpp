...
int main() {
  ...
  Config base;
  motion::config::seedBuiltinWidgets(base);
  ...
  const WidgetConfig temp = motion::config::readBarWidgetConfig("temp", *tempTable, base);
  ...
  const WidgetConfig custom = motion::config::readBarWidgetConfig("my_clock", *customTable, base);
  ...
  const WidgetConfig layout = motion::config::readBarWidgetConfig("keyboard_layout", *layoutTable, base);
