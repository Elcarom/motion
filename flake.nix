  ...
  outputs =
    ...
    in
    {
      overlays.default = final: prev: {
        motion = final.callPackage ./nix/package.nix { };
      };
      ...
      devShells = forEachSystem (
        { pkgs, system }:
        {
          default = pkgs.callPackage ./nix/devshell.nix {
            motion = self.packages.${system}.default;
          };
        }
      );
      ...
      homeModules.default =
        { pkgs, lib, ... }:
        {
          ...
          programs.motion.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.default;
        };
