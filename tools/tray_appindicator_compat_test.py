...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Richer GTK/AppIndicator tray compatibility harness for Motion submenu testing."
    )
    parser.add_argument(
        "--force-appindicator",
        action="store_true",
...
class CompatTrayHarness:
    ...
    def setup(self) -> None:
        if self.backend_module is None:
            ...
            self.status_icon.set_name("motion-tray-appindicator-compat-test")
        ...
        self.indicator = self.backend_module.Indicator.new(
            "motion-tray-appindicator-compat-test",
            "applications-system",
