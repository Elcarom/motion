;;; motion-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme motion "Theme using Template variables with quality of life improvements.")
